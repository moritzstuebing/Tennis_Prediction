...
def chrono_split(X, y, threshold):
...
def mse(y, y_hat):
    ...
    """
        Calculates the mean squared error between a vector of model predictions and true values.  
    """
...
def ridge_mse(y, y_hat, lam, theta):
    ...
    """
        ...
        calculates the ridge regularised mean squared error between a vector of predictions and 
        true values.
    """
